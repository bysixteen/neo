...
(function () {
  ...
  var staticNav = [
    ...
    },
    {
      ...
      defaultOpen: true,
      items: [
        { id: 'principles', text: 'Principles', path: 'principles.html' },
        { id: 'decisions', text: 'Decisions', path: 'decisions.html' },
        { id: 'personas', text: 'Personas', path: 'personas.html' },
        { id: 'backlog', text: 'Backlog', path: 'backlog.html' },
        { id: 'dissent', text: 'Dissent Register', path: 'dissent.html' }
      ]
    }
  ];
  ...
  logoLink.textContent = 'Alexa Expression System';

  var version = document.createElement('div');
  version.className = 'version';
  version.textContent = 'Sprint 000';
